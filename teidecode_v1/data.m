...
%% Test for the power generated by the payload
SC1qgen = zeros(1,length(ti)); %W
SC2qgen = zeros(1,length(ti)); %W
SC3qgen = zeros(1,length(ti)); %W
SC4qgen = zeros(1,length(ti)); %W

SC1qgen (1,44300:44310)=100; 
SC2qgen (1,44300:44310)=100; 
SC3qgen (1,44300:44310)=100; 
SC4qgen (1,44300:44310)=100; 
